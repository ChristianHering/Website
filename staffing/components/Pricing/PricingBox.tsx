      ...
      >
        ...
        <div className="mb-8 border-b border-body-color border-opacity-10 pb-8 dark:border-white dark:border-opacity-10">
          <Link
            href={
              "/contact?message=" +
              encodeURIComponent("Hi, I'm looking to fill ___ ") +
              encodeURIComponent(packageName) +
              encodeURIComponent(" positions at my company.") +
              encodeURIComponent(" I'm also interested in ___.") +
              encodeURIComponent(" My phone number is +1 (234)-567-890.") +
              encodeURIComponent(" Please contact me Monday to Friday between ___am and ___pm UTC.") +
              encodeURIComponent(" Thank you.")
            }
