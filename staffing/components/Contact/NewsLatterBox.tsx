  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Looking for a service quote? Send us a call back request and we'll get in touch!
      </p>
      <form>
        <input
          type="text"
        ...
        <Script id="cf-turnstile-callback">
          {`window.onloadTurnstileCallback = function () {
            window.turnstile.render('#my-widget', {
              sitekey: '0x4AAAAAAAKnciJeT9-Rt5Ci',
            })
          }`}
        </Script>
        <Script
          ...
          defer={true}
        />
        <div id="my-widget" className="checkbox mb-4 w-full py-3 px-6 text-body-color placeholder-body-color outline-none focus-visible:shadow-none" />
        <input
          type="submit"
          value="Submit"
